...
// Funções utilitárias (opcional, para futuras melhorias)
// function setLoading(isLoading) {
//   const btn = document.querySelector('.search button');
//   btn.textContent = isLoading ? 'Carregando...' : '🔎';
// }

// function showError(msg) {
//   alert(msg); // depois pode virar toast bonito
// }

// function salvarCidade(nome) {
